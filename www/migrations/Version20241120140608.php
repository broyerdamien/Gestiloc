 ...
 */
final class Version20241120140608 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis_echeance (id INT AUTO_INCREMENT NOT NULL, location_id INT NOT NULL, date_debut DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', date_fin DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', payment_status VARCHAR(20) NOT NULL, amount DOUBLE PRECISION NOT NULL, INDEX IDX_A9912F9E64D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
